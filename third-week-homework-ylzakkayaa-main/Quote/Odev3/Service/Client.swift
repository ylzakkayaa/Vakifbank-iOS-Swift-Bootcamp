...
class Client {
    ...
    class func getRandom(completion: @escaping (RandomModel?, Error?) -> Void) {
        taskForGETRequest(url: Endpoints.randomQuotes.url, responsetType: RandomModel.self) { response, error in
